...
import LoginForm from '@/pages/chat/hengda/components/loginForm/LoginForm';
import dynamic from 'next/dynamic';
import { serviceSideProps } from '@/web/common/utils/i18n';
import { clearToken, setToken } from '@/web/support/user/hengda/auth';
...
const RegisterForm = dynamic(() => import('@/pages/chat/hengda/components/RegisterForm'));
const ForgetPasswordForm = dynamic(() => import('@/pages/chat/hengda/components/ForgetPasswordForm'));
...
const Login = () => {
  ...
  const loginSuccess = useCallback(
    (res: ResLogin) => {
      ...
      setToken(res.token);
      setTimeout(() => {
        router.push(lastRoute ? decodeURIComponent(lastRoute) : '/chat/hengda/share');
      }, 300);
    },
  ...
  useMount(() => {
    clearToken();
    router.prefetch('/chat/hengda/share');
